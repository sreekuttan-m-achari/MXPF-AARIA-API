...
| astra-winmagictoys-prod | winmagictoys-prod | ip-172-26-11-193 | env=prod, role=vps, cloud=aws, site=winmagictoys | health, exec | approved |
| astra-winmagictoys-v2 | winmagictoys-v2 | ip-172-26-8-140 | env=prod, role=vps, cloud=aws, site=winmagictoys, host=v2 | health, exec | approved |
<!-- FLEET:END -->
